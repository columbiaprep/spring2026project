...
export function SouthTheaterStairsBottom(props) {
  const { nodes, materials } = useGLTF('/SouthTheaterStairsBottom.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.stairs31.geometry}
        material={nodes.stairs31.material}
      />
      <mesh
        castShadow
        receiveShadow
...
useGLTF.preload('/SouthTheaterStairsBottom.glb')
