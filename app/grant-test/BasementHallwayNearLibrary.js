...
export function BasementHallwayNearLibrary(props) {
  const { nodes, materials } = useGLTF('/BasementHallwayNearLibrary.glb')
  return (
...
useGLTF.preload('/BasementHallwayNearLibrary.glb')
