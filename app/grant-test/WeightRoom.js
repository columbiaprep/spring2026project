...
export function WeightRoom(props) {
  const { nodes, materials } = useGLTF('/WeightRoom.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.floor_Bedroom.geometry}
        material={nodes.floor_Bedroom.material}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.floor_Bedroom_2.geometry}
        material={nodes.floor_Bedroom_2.material}
      />
      <mesh
        castShadow
        receiveShadow
...
useGLTF.preload('/WeightRoom.glb')
