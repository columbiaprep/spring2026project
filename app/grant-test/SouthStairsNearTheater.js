...
export function SouthStairsNearTheater(props) {
  const { nodes, materials } = useGLTF('/SouthStairsNearTheater.glb')
  return (
...
useGLTF.preload('/SouthStairsNearTheater.glb')
